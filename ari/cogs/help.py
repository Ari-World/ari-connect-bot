...
class Help(commands.Cog):
    ...
    async def global_commands(self, ctx):
        ...
        embed.add_field(name="1. a!connect", value="> **Description:** Connects the channel to global world lobby", inline=False)
        embed.add_field(name="2. a!switch ", value="> **Description:** Connects the channel to global world lobby", inline=False)
        embed.add_field(name="3. a!lobbies", value="> **Description:** Check for available lobbies", inline=False)
